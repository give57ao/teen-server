                 ...
                 <ul class="tap_list">
                    ...
                    <li class="tap_wrap">
                       ...
                       <div class="tap_list_del">
                          ...
                          <a onclick="deleteChatAlarm(${chat.alarm_no})"><img src="/teen/resources/images/icon/icon_delete.svg"></a>
                       </div>
                    </li>
                    </c:forEach>
                 </ul>
            ...
            <div class="tap_c tap_follow" id="tap_follow">
               <ul class="tap_list">
                    ...
                    <li class="tap_wrap">
                       ...
                       <div class="tap_list_del">
                          <input type="hidden" name= "alarm_no" id= "alarm_no" value="${follow.alarm_no }"/>
                          <a onclick="deleteFollowAlarm(${follow.alarm_no})"><img src="/teen/resources/images/icon/icon_delete.svg"></a>
                       </div>
                    </li>
                    </c:when>
